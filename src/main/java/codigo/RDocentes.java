...
public class RDocentes {
    ...
    public void Insertar(JComboBox combo,JTextField paramCedula, JTextField paramNombre, JTextField paramApellido, JTextField paramDireccion, JTextField paramTelefono, JTextField paramNacimiento){
       ...
       Conexion con = new Conexion();
        ...
        System.out.print(getNacimiento());    
            cs.execute();
